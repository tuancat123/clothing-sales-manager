...
public class Invoice extends JPanel {
    ...
    private void initComponents() {
        ...
        EmployeeInfo.setBorder(BorderFactory.createEmptyBorder(5, 12, 5, 5));
        EmployeeInfo.setLayout(new GridLayout(2, 0));
        EmployeeInfo.setBackground(color);

        EmployeeName.setText("Bành Văn A");
        EmployeeName.setFont(new Font("Segoe UI", 0, 14));
        EmployeeInfo.add(EmployeeName);

        Detail.add(EmployeeInfo, BorderLayout.CENTER);
